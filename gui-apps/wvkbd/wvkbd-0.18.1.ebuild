...
# 0.18.1 is a patch on 0.18, so trim '.1'
MY_PV="${PV:0:4}"
SRC_URI="https://github.com/jjsullivan5196/${PN}/archive/refs/tags/v${MY_PV}.tar.gz -> ${PN}-${MY_PV}.tar.gz"
S="${WORKDIR}/${PN}-${MY_PV}"
...
PATCHES=(
    "${FILESDIR}/wvkbd-${MY_PV}-crash.patch"
)
